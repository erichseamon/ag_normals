...
jj=1
xrangeyearallcounties <- subset(xrange, commodity == "WHEAT" & damagecause == "Drought" & year == 2011)

for (ii in unique(xrangeyearallcounties$county)) {
  


xrangeyear <- subset(xrange, county == ii & commodity == "WHEAT" & damagecause == "Drought" & year == 2011)
...
xrange3 <- subset(xrange2, county == ii & commodity == "WHEAT" & damagecause == "Drought")
...
xrange3full <- subset(xrange2full, county == ii & commodity == "WHEAT" & damagecause == "Drought")
